...
\path{artifacts/audio_phenomena_expansion_20260907/latex/interpretable_audio_thesis_working_20260912_en.tex}.
From its containing directory, the retained build command is
\begin{verbatim}
latexmk -pdf -interaction=nonstopmode -halt-on-error \
  interpretable_audio_thesis_working_20260912_en.tex
\end{verbatim}
...
The eight-family BC and YuE2 extension outcomes remain unfinished in this
document. Their terminal bindings must be added before final submission.
