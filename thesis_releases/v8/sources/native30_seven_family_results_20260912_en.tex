...
\subsection{Reproduction references and completed extensions}
...
The public archive is \href{https://huggingface.co/datasets/EZMONYI/music-ai-human-test-audio}{the EZMONYI HF evaluation dataset}. Intermediate reports remain preserved alongside later completed results; full-corpus audio publication is still incomplete. The completed eight-family BC comparison, YuE2 transfer, and expanded-cohort evaluations are reported in the following sections, with their own terminal result bindings. Metadata schedules alone are not evidence of completed fits.
