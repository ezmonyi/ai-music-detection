...
VERSION = 'summarize_native30_evaluation_bc_v3'
...
def _validate_external_code_bindings(contract):
    ...
    # This historical test is not an input bound by the BC evaluator. Verify
    # its exact pin as an additional report-time reference, not frozen lineage.
    result['report_time_reference:test_evaluate_native30_v3.py'] = binding(
        HERE / 'test_evaluate_native30_v3.py', V3_EVALUATOR_TEST_SHA)
    return result
