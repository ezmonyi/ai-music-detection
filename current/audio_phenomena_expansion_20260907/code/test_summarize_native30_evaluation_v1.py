...
import summarize_native30_evaluation_v1 as m
...
def synthetic_publication(directory):
    ...
    code_bindings = {name: m.binding(m.HERE / name) for name in ('evaluate_native30_v1.py', 'test_evaluate_native30_v1.py')}
    contract = {'version': 'evaluate_native30_v1', 'stage': 'native30_seven_family_schedule_only_development_evaluation_v1',
    ...
    write(freeze_path, {'version': 'native30-evaluation-parent-freeze-v1', 'status': 'parent_frozen_for_native30_fold_only_fitting',
    ...
    write(root / 'manifest.json', {'version': 'evaluate_native30_v1', 'contract_sha256': contract_sha, 'model_instances': len(valid),
    ...
    write(root / 'COMMIT.json', {'version': 'evaluate_native30_v1', 'status': 'committed_fold_only_evaluation_not_model_selection',
