...
import run_native30_bc_v1 as m
...
class AuthorityTests(unittest.TestCase):
    ...
    def gate_fixture(self, gate=True):
        from test_summarize_bc_reserved_admission_v1 import Fixture
        fixture = Fixture(gate=gate); self.addCleanup(fixture.close)
        decision = {'version': 'bc_native30_transfer_decision_v1',
            ...
            'producer_commit_sha256': fixture.commit_entry['sha256'], 'tolerances_and_scientific_margins_unchanged': True}
        request = {'audit': fixture.audit_entry, 'producer_commit': fixture.commit_entry,
