...
import prepare_native30_evaluation_inputs_v1 as old

import prepare_native30_evaluation_inputs_v2 as m
...
class AssemblerTests(unittest.TestCase):
    ...
    def test_v2_exact_approved_backend_pin_scope_and_predictor_exclusion(self):
        version = 'extract_native30_sdrp_recovery_v2'
        self.assertEqual(m.SDRP_BACKENDS[version]['runner_sha256'],
                         'c6e1faa044cb2ff9e9e4c6d66ee055b887d631525ff776778b929f6453317122')
        ...
        with tempfile.TemporaryDirectory() as name:
            ...
            self.assertFalse(any('recovery' in key or 'beat_provenance' in key
    ...
    def test_v2_wrong_backend_pin_rejected_not_latest_lookup(self):
        version = 'extract_native30_sdrp_recovery_v2'
        with tempfile.TemporaryDirectory() as name:
    ...
    def test_synthetic_v1_v2_feature_table_and_metadata_parity(self):
        self.assertEqual(m.digest(Path(old.__file__)),
                         'c1b5e223d5ef2951fc93b12da9d82c75f2cf616418d7b7f8704d4225a4c95bb7')
        ...
        with tempfile.TemporaryDirectory() as name:
            ...
            new_args, _, _, _ = self.fixture(root / 'new', recovery=True,
                                           recovery_version='extract_native30_sdrp_recovery_v2')
