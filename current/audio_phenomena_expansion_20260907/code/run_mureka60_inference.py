#!/usr/bin/env python3
"""Measurement-only Mureka500 inference; explicit idle GPUs, strict receipts.
...
import prepare_mureka60_inputs as prep
from prepare_mureka60_inputs import canonical_hash, json_bytes, publish, read_json, require, sha_file
...
def dependency_snapshot():
    ...
    names = [*PINNED_HELPERS, 'prepare_mureka60_inputs.py', 'run_mureka60_inference.py',
             'verify_extract_mureka60.py']
...
def validate_prepared(prepared, decode=True):
    ...
    source_rows, source_bindings = prep.audit_inputs(prep.SOURCE)
