...
import validate_guitarset_archives_v1 as source_validator

VERSION = "draft_bicoherence_guitarset_pilot_v1"
...
def code_bindings(design, validator):
    ...
    return {"design": binding(design), "draft_tool": binding(here),
            "draft_tests": binding(here.with_name("test_draft_bicoherence_guitarset_pilot_v1.py")),
...
def draft(source, source_commit_sha256, overlap_evidence, overlap_sha256, design, validator, output):
    ...
    try:
        ...
        write_new(output / "COMMIT.json", canonical({"status": "committed",
                  "kind": "guitarset_bc_partition_preprocessing_draft_only_v1",
