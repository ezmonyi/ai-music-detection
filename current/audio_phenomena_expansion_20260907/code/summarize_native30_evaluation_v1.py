...
VERSION = 'summarize_native30_evaluation_v1'
EVALUATOR_SHA = '115b37dd24f0dae647b955715c4cb4432314ff0f4e9e1a6206f33ed70e64eff5'
EVALUATOR_TEST_SHA = '9ef82ac0412509652aa1637244814247b5af313852d69466fb7870928bcb7791'
...
def inspect_evaluation(root, commit_sha, expected=EXPECTED):
    ...
    require(commit['version'] == 'evaluate_native30_v1' and commit['status'] == 'committed_fold_only_evaluation_not_model_selection'
    ...
    require(contract['version'] == 'evaluate_native30_v1' and contract['stage'] == 'native30_seven_family_schedule_only_development_evaluation_v1'
    ...
    external_bindings = {}
    for name, pin in (('evaluate_native30_v1.py', EVALUATOR_SHA), ('test_evaluate_native30_v1.py', EVALUATOR_TEST_SHA)):
    ...
    require(manifest['version'] == 'evaluate_native30_v1' and manifest['contract_sha256'] == contract_sha and manifest['model_instances'] == expected['eligible']
    ...
    require(frozen['version'] == 'native30-evaluation-parent-freeze-v1'
