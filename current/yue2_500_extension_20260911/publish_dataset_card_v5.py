...
def main():
    ...
    new=(ROOT/'HF_DATASET_CARD_20260913_v5.md').read_bytes()
    ...
    if old==new:
        ...
        prior=ROOT/'HF_DATASET_CARD_before_v5.md'
        ...
        revision=api.create_commit(repo_id=REPO,repo_type='dataset',parent_commit=info.sha,
            ...
            commit_message='Update accepted stem releases and fixed public coverage checkpoint').oid
    ...
    out=ROOT/'dataset_card_v5_publication.json'
