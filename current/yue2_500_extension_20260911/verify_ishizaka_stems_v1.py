"""Anonymous fixed-revision acceptance of 312 historical maestro stems."""
import argparse
import hashlib
import json
...
from publish_ishizaka_stems_v1 import OUT, PREFIX, NOTICE, BATCH, build
...
def run():
    ...
    assert terminal['status'] == '312_ishizaka_stems_uploaded_hash_verified'
    assert terminal['objects'] == 312 and terminal['original_ids'] == 39
    rows, _ = build()
    ...
    return dict(revision=revision, verified_audio_objects=312, original_ids=39,
