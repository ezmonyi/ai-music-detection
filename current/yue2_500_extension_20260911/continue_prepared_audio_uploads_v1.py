"""Wait for current publishers, then serially upload prepared Suno/open-model vocals."""
import fcntl
import importlib
import json
import os
...
OUT = BASE / 'prepared_audio_upload_queue_v1'
DEPENDENCIES = ((3227951, 'hf_aime_test_views_v1'),
                (3228976, 'hf_open_model_test_views_v1'),
                (3229020, 'hf_fma_test_views_v1'))
TARGETS = ('publish_suno_test_views_v1', 'publish_open_model_vocals_v1')
