...
def main():
    ...
    out=ROOT/'legacy_spectral_locked_v2'
    ...
    write(out/'PROTOCOL.json',dict(source_commit_sha256=digest(source/'COMMIT.json'),
          ...
          alpha=10.0,threshold=0.0,target_encoding='labels*2-1 (original legacy implementation)',train_items=800,test_items=200,group_disjoint=True,
