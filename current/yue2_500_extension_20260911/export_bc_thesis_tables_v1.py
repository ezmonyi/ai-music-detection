"""Export committed BC results without fitting, ranking, or model selection."""
import csv
import hashlib
import json
...
SOURCE=ROOT/'native30_bc_evaluation_report_v3_20260912'
PIN='ad5223a5f1f0fb667fe38a1e0c214b28ab8a8d0b57f01f912521885aa1c0213b'
...
def main():
    ...
    out=ROOT/'bc_thesis_tables_v1';out.mkdir(exist_ok=False)
    ...
    with (out/'bc_tables_generated.tex').open('x') as stream:stream.write('\n'.join(tex)+'\n')
