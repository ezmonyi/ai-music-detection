"""Wait for human stem queue, then preserve DiffRhythm and Ishizaka stems."""
import fcntl
import importlib
import json
import os
...
OUT = BASE / 'pilot_cc0_stem_upload_queue_v1'
DEPENDENCIES = ((3283769, 'hf_maestro_stems_v1'), (3283769, 'hf_mtt_stems_v1'))
TARGETS = ('publish_diffrhythm_stems_v1', 'publish_ishizaka_stems_v1')
