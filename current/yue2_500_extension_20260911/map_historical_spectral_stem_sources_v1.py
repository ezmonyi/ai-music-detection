"""Bind verified vocal objects to exact historical metadata; do not grant rights."""
import argparse
import csv
import hashlib
import json
...
def main(datasets, out):
    ...
    inventory = datasets / 'historical_spectral_stem_objects_v1/objects.json'
    assert digest(inventory) == 'a2b302b0c221e8a6c118c5b0593c81763d293a4a18818c5267ff6e0017f3d92b'
