...
import evaluate_native30_v2 as m
import evaluate_native30_v1 as old
...
class EvaluatorTests(unittest.TestCase):
    ...
    def test_v2_pins_and_v1_numerical_receipt_parity_all_three_modes(self):
        self.assertEqual(m.io.digest(Path(old.__file__)),
                         '115b37dd24f0dae647b955715c4cb4432314ff0f4e9e1a6206f33ed70e64eff5')
        self.assertEqual(m.PREPARER_NAME, 'prepare_native30_evaluation_inputs_v2')
    ...
    def test_v2_wrong_assembler_pin_cannot_load(self):
        with self.assertRaisesRegex(ValueError, 'code pin'):
            m.load_module(m.HERE / (m.PREPARER_NAME + '.py'), '0' * 64, '_wrong_v2_pin')
