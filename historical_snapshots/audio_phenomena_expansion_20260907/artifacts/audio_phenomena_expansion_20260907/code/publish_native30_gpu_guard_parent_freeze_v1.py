...
BUILDER_SHA = 'b87557dd25ab05a7fd6e737f0add5f9ba828b029956d77479975ddc978d60455'
...
def main():
    ...
    driver = ROOT / 'code/resume_native30_gpu_guard_v1.py'
    require(Path(s.__file__).resolve() == driver, 'unexpected driver origin')
    b.require_hash(driver, DRIVER_SHA)
    draft_path = ROOT / 'preregistration/native30_gpu_guard_parent_draft_v1.json'
    audit_path = ROOT / 'audit/native30_gpu_guard_draft_inventory_v1.json'
    ...
    require(draft['output_root'] == '/mnt/nfs-data/users/yi/audio_phenomena_expansion_20260907/native30_gpu_guard_resume_v1',
    ...
    target = ROOT / 'preregistration/native30_gpu_guard_parent_freeze_v1.json'
