...
VERSION = 'summarize_native30_evaluation_v2'
EVALUATOR_SHA = '586d6d99d63fd4c43684a7fd5a781a7fcdf674c3352ca5f9b4a434d9ccd4ae4b'
EVALUATOR_TEST_SHA = 'e0d0397bf9609abe62260ad197b4ee76b1531daa73c8294683b38ff30cadb333'
...
def inspect_evaluation(root, commit_sha, expected=EXPECTED):
    ...
    require(commit['version'] == 'evaluate_native30_v2' and commit['status'] == 'committed_fold_only_evaluation_not_model_selection'
    ...
    require(contract['version'] == 'evaluate_native30_v2' and contract['stage'] == 'native30_seven_family_schedule_only_development_evaluation_v2'
    ...
    external_bindings = {}
    for name, pin in (('evaluate_native30_v2.py', EVALUATOR_SHA), ('test_evaluate_native30_v2.py', EVALUATOR_TEST_SHA)):
    ...
    require(manifest['version'] == 'evaluate_native30_v2' and manifest['contract_sha256'] == contract_sha and manifest['model_instances'] == expected['eligible']
    ...
    require(frozen['version'] == 'native30-evaluation-parent-freeze-v2'
