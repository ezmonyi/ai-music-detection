...
### Latest verified checkpoint (2026-09-13)

Fixed public revision `b5231d23713673e90c65e70767485ef5aaf70a56` contains
42,011 direct audio/MIDI paths and 187,396,624,629 logical bytes. Archive
members are excluded. File paths, derived versions and songs are not equivalent.

Ten independently accepted historical stem supplements contain 16,422 unique
objects (47,275,922,568 bytes): open-model vocals 1,958; AIME vocals 5,000;
MAESTRO stems 2,400; MagnaTagATune stems 2,000; DiffRhythm pilot stems 400;
Ishizaka stems 312; additional Suno stems 1,300; additional ACE-Step/HeartMuLa
stems 600; additional Udio stems 2,000; and per-track-license-screened FMA
stems 452. These uploads have finished and passed anonymous fixed-revision
manifest, notice and remote hash/size checks; acceptance is not a full audio
redownload. FMA attribution and exact license URLs remain per recording.

Against the public snapshot, the frozen 31,378-object historical stem scope
has 16,422 matches and 14,956 unmatched objects (50,814,442,064 bytes).
A separate current-only inventory has 27,174 objects, two matching and 27,172
unmatched (68,652,547,568 bytes). The scopes overlap; do not sum their totals.
Current-only file hashes do not establish historical experimental provenance.
Matching excludes archive contents and private backups and grants no rights.

The frozen 14,244-object processed-input scope has preservation coverage through
966 older public-snapshot matches, 8,794 accepted public supplement objects,
and 4,484 locally archived rights-held objects. The private archive is not
published here. This scope-specific closure is not whole-project completion.

[Pinned snapshot and matching evidence](https://github.com/ezmonyi/ai-music-detection/tree/main/datasets/stem_public_snapshot_match_v3)
and [ten-release acceptance coverage](https://github.com/ezmonyi/ai-music-detection/tree/main/datasets/accepted_historical_stem_coverage_v2)
retain the exact revisions, hashes and coverage limits.

### Earlier source-publication checkpoints
...
The earlier fixed snapshot at `caed9220f68b258e9c2dcb89792ccb1fe4d1dc61` contains
